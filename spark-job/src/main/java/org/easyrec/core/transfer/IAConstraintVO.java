 ...
 */
package org.easyrec.core.transfer;


import java.io.Serializable;

//import static org.easyrec.store.dao.BaseItemAssocDAO.DEFAULT_ASSOC_VALUE_COLUMN_NAME;
...
public class IAConstraintVO<I extends Comparable<I>, T extends Comparable<T>> implements Serializable {
    ...
    public IAConstraintVO(Integer numberOfResults) {
        this(numberOfResults, null, null, null, null, null, null, DEFAULT_ASSOC_VALUE_COLUMN_NAME);
    }

    public IAConstraintVO(Integer numberOfResults, I tenant) {
        this(numberOfResults, null, null, null, tenant, null, null, DEFAULT_ASSOC_VALUE_COLUMN_NAME);
    }

    public IAConstraintVO(Integer numberOfResults, Boolean sortAsc) {
        this(numberOfResults, null, null, null, null, null, sortAsc, DEFAULT_ASSOC_VALUE_COLUMN_NAME);
    }

    public IAConstraintVO(Integer numberOfResults, Boolean active, Boolean sortAsc) {
        this(numberOfResults, null, null, null, null, active, sortAsc, DEFAULT_ASSOC_VALUE_COLUMN_NAME);
    }

    public IAConstraintVO(Integer numberOfResults, T viewType, I tenant) {
        this(numberOfResults, viewType, null, null, tenant, null, null, DEFAULT_ASSOC_VALUE_COLUMN_NAME);
    }

    public IAConstraintVO(Integer numberOfResults, T viewType, I tenant, Boolean active) {
        this(numberOfResults, viewType, null, null, tenant, active, null, DEFAULT_ASSOC_VALUE_COLUMN_NAME);
    }

    public IAConstraintVO(Integer numberOfResults, T viewType, T sourceType, I tenant) {
        this(numberOfResults, viewType, sourceType, null, tenant, null, null, DEFAULT_ASSOC_VALUE_COLUMN_NAME);
    }

    public IAConstraintVO(Integer numberOfResults, T viewType, T sourceType, I tenant, Boolean active) {
        this(numberOfResults, viewType, sourceType, null, tenant, active, null, DEFAULT_ASSOC_VALUE_COLUMN_NAME);
    }

    public IAConstraintVO(Integer numberOfResults, T viewType, T sourceType, String sourceInfo) {
        this(numberOfResults, viewType, sourceType, sourceInfo, null, null, null, DEFAULT_ASSOC_VALUE_COLUMN_NAME);
    }

    public IAConstraintVO(Integer numberOfResults, T viewType, T sourceType, String sourceInfo, Boolean active) {
        this(numberOfResults, viewType, sourceType, sourceInfo, null, active, null, DEFAULT_ASSOC_VALUE_COLUMN_NAME);
    }

    public IAConstraintVO(Integer numberOfResults, T viewType, Boolean sortAsc) {
        this(numberOfResults, viewType, null, null, null, null, sortAsc, DEFAULT_ASSOC_VALUE_COLUMN_NAME);
    }

    public IAConstraintVO(Integer numberOfResults, T viewType, Boolean active, Boolean sortAsc) {
        this(numberOfResults, viewType, null, null, null, active, sortAsc, DEFAULT_ASSOC_VALUE_COLUMN_NAME);
    }

    public IAConstraintVO(Integer numberOfResults, T sourceType, String sourceInfo, Boolean sortAsc) {
        this(numberOfResults, null, sourceType, sourceInfo, null, null, sortAsc, DEFAULT_ASSOC_VALUE_COLUMN_NAME);
    }

    public IAConstraintVO(Integer numberOfResults, T sourceType, String sourceInfo, Boolean active, Boolean sortAsc) {
        this(numberOfResults, null, sourceType, sourceInfo, null, active, sortAsc, DEFAULT_ASSOC_VALUE_COLUMN_NAME);
    }
        ...
        public IAConstraintVO(Integer numberOfResults, T viewType, T sourceType, String sourceInfo, I tenant,
            ...
            this(numberOfResults, viewType, sourceType, sourceInfo, tenant, active, sortAsc, DEFAULT_ASSOC_VALUE_COLUMN_NAME);
        }
